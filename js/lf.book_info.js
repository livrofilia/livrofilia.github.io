...
for ( i = 1; i <= $( '.book_info' ).size(); i++ )
{
  ...
  + "  </div>"
  + "  <div class='lf-book-info-info'>"
  + "   <div class='lf-book-info-overlay'>"
  + "    <ul>"
  ...
  + "      <li class='lf_Li_linkDoWattpad'><strong><a href='" + livro[i].linkDoWattpad + "' target='_blank' rel='nofollow'><i class='far fa-hand-point-right'></i> Leia no Wattpad</a></strong></li>"
  + "      <br>"
  + "      <li class='lf_Li_linkDaResenha'><strong><a href='" + livro[i].linkDaResenha + "' target='_blank' rel='nofollow'><i class='far fa-hand-point-right'></i> Leia a Resenha do Livrofilia</a></strong></li>"
